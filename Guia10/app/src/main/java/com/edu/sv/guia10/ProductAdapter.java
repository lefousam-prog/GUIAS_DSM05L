            ...
            call.enqueue(new Callback<Respuesta>() {
                ...
                public void onResponse(Call<Respuesta> call, Response<Respuesta> response) {
                    ...
                    if (r.getResultado()==1) {
                        ...
                        /*con esta linea de codigo recargamos la MainActivity para que
                        * con el metodo de onStart vuelva a hacer la consulta a la api
                        * y asi actualizar de una vez el producto en la lista luego de ser
                        * eliminado*/
