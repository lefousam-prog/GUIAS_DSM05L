...
public class MainActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    /*Cada vez que esta activity quede en pause, al volver a iniciarse
    * este llamara el metodo que muestra todos los productos para poder
    * hacer una actualizacion de la lista*/
    @Override
